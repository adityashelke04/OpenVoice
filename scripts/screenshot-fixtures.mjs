...
/** Copied from `ov-format/src/dictionary.rs`, in the order the reference's
 *  Dictionary screen lists them (the screen shows the stored order, and a
 *  user's settings file can hold its terms in any order). */
const DICTIONARY = [
