...
**[⬇ Download for Windows](https://github.com/adityashelke04/OpenVoice/releases/download/v0.3.0/OpenVoice_0.3.0_x64-setup.exe)** — one `.exe`, speech engine included.
...
> formatting, injection, and history all work on Windows, and `v0.3.0` is
...
Download **[`OpenVoice_0.3.0_x64-setup.exe`](https://github.com/adityashelke04/OpenVoice/releases/download/v0.3.0/OpenVoice_0.3.0_x64-setup.exe)**
...
- **The installer is not code-signed.** Windows SmartScreen will warn about an
  ...
  ```powershell
  Get-FileHash .\OpenVoice_0.3.0_x64-setup.exe -Algorithm SHA256
  ```
